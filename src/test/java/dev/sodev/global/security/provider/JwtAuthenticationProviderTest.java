...
public class JwtAuthenticationProviderTest {
    ...
    @BeforeEach
    public void setup() {
        provider = new JwtAuthenticationProvider("validSecretKeyvalidSecretKeyvalidSecretKeyvalidSecretKeyvalidSecretKey");
    }

    private String createToken(String memberEmail, List<String> roles, Date now, int expireMin, String secretKey) {
    ...
    public void givenTokenMadeByDifferentSecretKey_whenCallAuthentication_thenThrowJwtInvalidException() {
        ...
        String invalidToken = createToken("lee@naver.com", Collections.singletonList("ROLE_ADMIN"), new Date(), 30, "invalidSecretKeyinvalidSecretKeyinvalidSecretKeyinvalidSecretKeyinvalidSecretKey");
    ...
    public void givenExpiredToken_whenCallAuthentication_thenThrowJwtInvalidException() {
        ...
        String invalidToken = createToken("lee@naver.com", Collections.singletonList("ROLE_ADMIN"), past, 5, "validSecretKeyvalidSecretKeyvalidSecretKeyvalidSecretKeyvalidSecretKey");
        JwtAuthenticationToken authentication = new JwtAuthenticationToken(invalidToken);
    ...
    public void givenValidToken_whenCallAuthentication_thenReturnAuthentication() {
        ...
        String validToken = createToken("lee@naver.com", Collections.singletonList("ROLE_ADMIN"), new Date(), 30, "validSecretKeyvalidSecretKeyvalidSecretKeyvalidSecretKeyvalidSecretKey");
        ...
        assertThat(authenticated.getPrincipal(), equalTo("lee@naver.com"));
