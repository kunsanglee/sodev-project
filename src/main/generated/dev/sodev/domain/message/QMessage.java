...
public class QMessage extends EntityPathBase<Message> {
    ...
    private static final long serialVersionUID = 1740000356L;
    ...
    public QMessage(Class<? extends Message> type, PathMetadata metadata, PathInits inits) {
        ...
        this.chat = inits.isInitialized("chat") ? new dev.sodev.domain.chat.QChat(forProperty("chat"), inits.get("chat")) : null;
