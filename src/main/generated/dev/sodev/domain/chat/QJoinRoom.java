...
public class QJoinRoom extends EntityPathBase<JoinRoom> {
    ...
    private static final long serialVersionUID = 1822971775L;
    ...
    public final dev.sodev.domain.message.QMessage message;
    ...
    public QJoinRoom(Class<? extends JoinRoom> type, PathMetadata metadata, PathInits inits) {
        ...
        this.message = inits.isInitialized("message") ? new dev.sodev.domain.message.QMessage(forProperty("message"), inits.get("message")) : null;
    }
